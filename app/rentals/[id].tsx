...
export default function RentalDetailScreen() {
  ...
  const featuredImageUrl = React.useMemo(() => {
    ...
    if (
      typeof rental.featured_image === "object" &&
      rental.featured_image !== null &&
      "url" in rental.featured_image
    ) {
              ...
              {isValidData(rental.cta_2_link?.title) ? (
                <PrimaryButton
                  ...
                  style={{
                    ...
                    borderWidth: 1,
                    borderColor: primaryColor || "#ea0b0b",
                  }}
                  textStyle={{
                    color: isDark ? "#FFFFFF" : primaryColor || "#ea0b0b",
                  }}
                />
              ) : null}
            </View>
